...
=== Elemenst of Reinforcement Learning
#tool.definition()[
  مؤلفه های Reinforcement Learning شامل موارد زیر است:
  #tool.custom_figure(
    image("images/ML/18_05.png"),
    caption: "مؤلفه های Reinforcement Learning",
  )
]
...
#tool.definition()[
  #tool.custom_figure(
    image("images/ML/18_06.png"),
    caption: "Policy and Cumulative Reward",
  )
  در فرمول اول تصویر بالا برای آن که دچار اشتباه نشویم، به اولین $pi$، پای و به دومین $pi$ که برای احتمال است، همان پی می گوییم.
...
#tool.definition()[
  #tool.custom_figure(
    image("images/ML/18_07.png"),
    caption: "معادله Bellman",
  )
]

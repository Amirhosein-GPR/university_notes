...
#tool.example(pause: true)[
  ...
  $
    x in C_1 "iff" p(C_1 | x) > p(C_2 | x) arrow.curve.b \ (p(C_1) times p(x | C_1)) / p(x) > (p(C_2) times p(
      x | C_2
    )) / p(x)
  $
...
#tool.double_section()[
  #tool.tip()[
    ...
    هر یک از نورون های @image_12_03، یک Classifer خطی است.
